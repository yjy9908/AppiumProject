...
from connect_20230620.data.data_from_json_yaml import read_data_from_json_yaml
...
class TestLogin:
    ...
    @pytest.mark.parametrize('phone,pswd',read_data_from_json_yaml("../data/account.json"))
